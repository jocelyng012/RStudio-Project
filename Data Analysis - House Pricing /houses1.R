...
#' When area increases by 1%, the selling price is expected to increase by 0.542%. That
...
#' When area increases by 1%, the selling price is expected to increase by 0.00932%
...
#' 
#' When review the scatter plots from the previous three equations, the log-log
#' transformations makes a linear model seem most plausible.
